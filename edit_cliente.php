...
<head>
  ...
  <title>PayFlow | Editar Cliente</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <?php 
        ...
        $query_edit = "SELECT * FROM clientes WHERE id='$id'";
        $exec_edit = mysqli_query($conn, $query_edit);
        $info_cliente = mysqli_fetch_assoc($exec_edit);
    ?>
    <div class="container-fluid">
      <div class="row mb-3">
        <div class="col-12">  
    ...
    <div class="card border-top">
      <form method="POST" action="editar-cliente.php" class="sec-pad">
      <input type="hidden" name="id" value="<?=$info_cliente['id']?>">
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-group col-md-8 mt-2">
          ...
          <input type="text" name="nome" value="<?=$info_cliente['nome']?>" class="form-control" required>
        </div>
        <div class="form-group col-md-4 mt-2">
          <label for="nascimento" class="font-weight-bold ml-2">Data de Nascimento</label>
          <input type="date" name="nascimento" value="<?=$info_cliente['nascimento']?>" class="form-control" required>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-8">
          <label for="tipopessoa" class="font-weight-bold ml-2">CPF/CNPJ</label>
          <input type="text" name="cpf" value="<?=$info_cliente['cpf']?>" class="form-control" required>
        </div>
        <div class="form-group col-md-4">
          <label for="rg" class="font-weight-bold ml-2">RG</label>
          <input type="text" name="rg" value="<?=$info_cliente['rg']?>" class="form-control" placeholder="00.000.000" data-mask="00.000.000" required>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="cep" class="font-weight-bold ml-2">CEP</label>
          <input type="text" name="cep" value="<?=$info_cliente['cep']?>" class="form-control" data-mask="00000.000" required>
        </div>
        <div class="form-group col-md-6">
          <label for="bairro" class="font-weight-bold ml-2">Bairro</label>
          <input type="text" name="bairro" value="<?=$info_cliente['bairro']?>" class="form-control" required>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-10">
          <label for="endereco" class="font-weight-bold ml-2" >Endereço</label>
          <input type="text" name="endereco" value="<?=$info_cliente['endereco']?>" class="form-control" required>
        </div>
        <div class="form-group  col-md-2">
          <label for="endereco" class="font-weight-bold ml-2">Número</label>
          <input type="text" name="numero" value="<?=$info_cliente['numero']?>" class="form-control" data-mask="00000" required>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-4">
          <label for="cidade" class="font-weight-bold ml-2">Cidade</label>
          <input type="text" name="cidade" value="<?=$info_cliente['cidade']?>" class="form-control" required>
        </div>
        <div class="form-group col-md-4">
          <label for="estado" class="font-weight-bold ml-2">Estado</label>
          <input type="text" name="estado" value="<?=$info_cliente['estado']?>" class="form-control" required>
        </div>
        <div class="form-group col-md-4">
          <label for="estado" class="font-weight-bold ml-2">País</label>
          <input type="text" name="pais" value="<?=$info_cliente['pais']?>" class="form-control" required>
        </div>
      </div> 
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="telefone" class="font-weight-bold ml-2">Telefone</label>
          <input type="text" name="telefone" value="<?=$info_cliente['telefone']?>" class="form-control" data-mask="(00) 0 0000-0000" >
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="celular" class="font-weight-bold ml-2">Celular</label>
          <input type="text" name="celular" value="<?=$info_cliente['celular']?>" class="form-control" data-mask="(00) 0 0000-0000" required>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="email" class="font-weight-bold ml-2">E-mail</label>
          <input type="email" name="email" value="<?=$info_cliente['email']?>" class="form-control" required>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <label for="cidade" class="font-weight-bold ml-2">Referência Comercial</label>
          <input type="text" name="comercial" value="<?=$info_cliente['comercial']?>" class="form-control">
        </div>
        <div class="form-group col-md-6">
          <label for="estado" class="font-weight-bold ml-2">Referência Pessoal</label>
          <input type="text" name="pessoal" value="<?=$info_cliente['pessoal']?>" class="form-control">
        </div>
      </div> 
      <div class="form-row">
      <div class="form-group col-md-12">
