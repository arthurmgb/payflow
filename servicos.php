    ...
    <section class="content">
      ...
      <div class="row mb-3">
        ...
        <div class="d-flex flex-row-reverse">
          <form class="form-inline" method="GET" action="servicos-search.php">
              ...
              <a class="ml-2" href="add_servico.php">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header card-payflow">
                <h3 class="card-title"><i class="fas fa-tasks mr-2"></i>Lista de Serviços</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
