...
$inserir_contrato = "INSERT INTO contratos (created, vencimento, valor, meses, observacoes, id_servico, id_cliente) VALUES (NOW(), '$vencimento', '$valor', '$meses', '$observacoes', 3, '$cliente_Id')";
