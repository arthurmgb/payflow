  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
      ...
      <?php 
        ...
        $query_edit = "SELECT * FROM servicos WHERE id='$id'";
        $exec_edit = mysqli_query($conn, $query_edit);
        $servicos = mysqli_fetch_assoc($exec_edit);
        ?>
    <div class="container-fluid">
    <div class="card border-top">
      <form method="POST" class="sec-pad" action="editar-servicos.php">
      <input type="text" name="id" value="<?=$servicos['id']?>">
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="cep" class="font-weight-bold ml-2">Nome do Serviço</label>
          <input type="text" name="servicos" value="<?=$servicos['servicos']?>" class="form-control">
        </div>
        <div class="form-group col-md-12">
